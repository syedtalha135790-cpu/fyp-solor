...
<head>
        ...
        <!-- App js -->
        <script src="backend/assets/js/plugin.js"></script>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="backend/assets/images/logo-light.svg" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div>
                                                    <img src="backend/assets/images/megamenu-img.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                                <div class="px-lg-2">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="backend/assets/images/brands/mail_chimp.png" alt="mail_chimp">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div data-simplebar style="max-height: 230px;">
                                    ...
                                    <a href="javascript: void(0);" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <img src="backend/assets/images/users/avatar-4.jpg"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-grow-1">
